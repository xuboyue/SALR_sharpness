...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        if epoch >= 0 and i % 2 == 0:
            ...
            sharp_a = get_sharpness_ascent(images, target, model, criterion, loss.item(), network=model, optimizer=optimizer, manifolds=0)
            sharp_d = get_sharpness_descent(images, target, model, criterion, loss.item(), network=model, optimizer=optimizer, manifolds=0)
