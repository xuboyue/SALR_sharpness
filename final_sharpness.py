# Code from GitHub: SmoothOut: Smoothing Out Sharp Minima to Improve Generalization in Deep Learning
# you can also use definition in SALR to calculate sharpness
